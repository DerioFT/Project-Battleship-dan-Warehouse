...
class AppPage(tk.Frame):
	...
	def create_left_header(self):
		...
		self.search_box_frame = tk.Frame(self.left_frame, bg="cyan", width=frame_w, height=frame_h//4)
		self.search_box_frame.pack(fill="x") # 5656

		self.entry_search_var = tk.StringVar()
		self.entry_search = tk.Entry(self.search_box_frame, bg="steelblue1", fg="black", font=("Arial", 12), textvariable=self.entry_search_var) # 5656
		self.entry_search.grid(row=0, column=0)

		self.button_search = tk.Button(self.search_box_frame, bg="turquoise3", fg="blue3", text="Find", font=("Arial", 12), command=self.clicked_search_btn) # 5656
	...
	def create_left_content(self):
		...
		self.items_list_box = tk.Listbox(self.left_content, bg="palegoldenrod", fg="black", font=("Arial", 12), height=frame_h) # 3434
